...
## Project Structure
    ...
    ├── social_media_mixer_28942  # Django project configurations
...
1. Clone this repo and `cd social_media_mixer_28942`
...
2. Clone this repo and `cd social_media_mixer_28942`
